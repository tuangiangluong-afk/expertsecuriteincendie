...
const PRODUCTION_URL = process.env.PRODUCTION_URL || 'https://expertsecuriteincendie.fr';
...
async function run() {
  console.log('🚀 Starting Google Indexing API OAuth2 for Expertextincteurprotection...');
  ...
  console.log('='.repeat(60));
  console.log(`🏁 Google OAuth2 Indexing Submission for Expertextincteurprotection Complete!`);
