...
import { NATIONAL_TARGETS, getTargetAsCityConfig } from "@/config/national-targets"; // Ghost Broker Strategy
...
// ========================================
// GENERATE PARTNER CITIES (Ghost Broker)
// ========================================
...
const ADAPTED_SITES = Object.entries(SITES).reduce((acc, [key, site]) => {
    acc[key] = {
        ...
        pricing: {
            ...
            description: "maintenance à partir de"
        },
