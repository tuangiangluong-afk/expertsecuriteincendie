 ...
 * 
 * Top 100+ cities by population and wealth for Incendie lead generation.
 * Used to generate /maintenance/[city] pages on the hub.
 */
...
// Top French cities for Incendie targeting
export const FRENCH_CITIES: CityData[] = [
    // Île-de-France - PREMIUM
    { slug: "paris", name: "Paris", department: "75", departmentName: "Paris", region: "Île-de-France", population: 2161000, postalCode: "75000", wealthIndex: 9, hasSniper: true, sniperDomain: "securiteincendieparis.fr" },
    { slug: "neuilly-sur-seine", name: "Neuilly-sur-Seine", department: "92", departmentName: "Hauts-de-Seine", region: "Île-de-France", population: 62000, postalCode: "92200", wealthIndex: 10, hasSniper: true, sniperDomain: "extincteur-protection-neuilly.fr" },
    ...
    // Grandes métropoles
    { slug: "lyon", name: "Lyon", department: "69", departmentName: "Rhône", region: "Auvergne-Rhône-Alpes", population: 522000, postalCode: "69000", wealthIndex: 8, hasSniper: true, sniperDomain: "extincteur-protection-lyon.fr" },
