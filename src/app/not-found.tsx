        ...
        <div className="min-h-screen bg-neutral-900 flex items-center justify-center p-4">
            <div className="text-center max-w-lg">
                ...
                <p className="text-slate-500 mb-10 leading-relaxed">
                    ...
                    Mais rassurez-vous, nos techniciens sont, eux, bien disponibles.
                </p>

                <Link
                    href="/"
                    className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-xl transition-all shadow-lg shadow-blue-600/20 hover:scale-[1.02]"
                >
                    <Home size={20} />
                    Retour à l'accueil
                </Link>
