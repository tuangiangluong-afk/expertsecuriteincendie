...
export const metadata: Metadata = {
    title: "Mentions Légales - Expert Sécurité Incendie",
    description: "Mentions légales, éditeur, hébergement et politique de confidentialité du réseau Expert Sécurité Incendie.",
            ...
            <main className="container mx-auto max-w-3xl px-4 py-12 lg:py-20">
                ...
                <div className="prose prose-neutral prose-lg max-w-none">
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        <h2 className="mb-4 text-2xl font-bold text-red-900">1. Éditeur du Site</h2>
                        <p>
                            Le site <strong>Expert Sécurité Incendie</strong> (expertsecuriteincendie.fr) est édité par la société <strong>WELINK TECH</strong>.
                        </p>
                        <ul className="list-none space-y-2 pl-0">
                            ...
                            <li><strong>Contact :</strong> <Link href="/home/contact" className="underline text-red-600">Formulaire de contact</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        <h2 className="mb-4 text-2xl font-bold text-red-900">3. Hébergement</h2>
                        <p>
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        <h2 className="mb-4 text-2xl font-bold text-red-900">4. Propriété Intellectuelle</h2>
                        <p>
                            L&apos;ensemble des contenus (textes, images, base de données, marque &quot;Expert Sécurité Incendie&quot;) est protégé par le droit de la propriété intellectuelle. Toute reproduction non autorisée est interdite.
                        </p>
                    </div>
