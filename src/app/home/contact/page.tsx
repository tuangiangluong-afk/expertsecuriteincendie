        ...
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-red-500 selection:text-white">
            ...
            <section className="pt-32 pb-12 lg:pt-40 lg:pb-20 px-6 bg-white overflow-hidden relative">
                ...
                <div className="mx-auto max-w-4xl text-center relative z-10">
                    <span className="inline-flex items-center rounded-full bg-red-50 border border-red-200 px-4 py-1.5 text-xs font-bold text-red-700 mb-8 tracking-widest uppercase">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-6 text-slate-900">
                        Un projet de <span className="text-red-600">protection</span> ?
                    </h1>
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
                        Particuliers, Copropriétés, Entreprises.
                        <br />
                        Obtenez votre étude personnalisée ou contactez notre équipe technique.
                    </p>
                </div>
            </section>
            ...
            <section className="pb-20 px-6">
                <div className="mx-auto max-w-6xl">
                    <div className="grid md:grid-cols-3 gap-8 mb-16 -mt-8">
                        {/* Card 1: Commercial */}
                        <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100 hover:border-red-200 transition text-center group">
                            <div className="mx-auto w-14 h-14 bg-red-50 rounded-2xl flex items-center justify-center mb-6 text-red-600 group-hover:scale-110 transition duration-300">
                                <Phone size={28} />
                            </div>
                            ...
                            <span className="text-lg font-bold text-red-600">Via le formulaire ci-dessous</span>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100 hover:border-red-200 transition text-center group">
                            ...
                            <span className="font-bold text-red-600">Via le formulaire ci-dessous</span>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/50 border border-slate-100 hover:border-red-200 transition text-center group">
                            ...
                            <p className="font-bold text-slate-900">Expert Sécurité Incendie</p>
                        </div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-5 gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="p-6 bg-red-50 rounded-2xl border border-red-100">
                                <h4 className="font-bold text-red-900 mb-2">Vous êtes technicien ?</h4>
                                <p className="text-sm text-red-700 mb-4">Rejoignez le 1er réseau d'apporteurs d'affaires qualifiés en France.</p>
                                <Link href="#form" className="text-sm font-bold text-red-600 hover:underline flex items-center gap-1">
                        ...
                        <div id="form" className="lg:col-span-3 bg-white rounded-3xl p-8 md:p-10 shadow-2xl border border-slate-100">
                            <div className="mb-8">
                                ...
                                <p className="text-slate-500">Remplissez le formulaire ci-dessous pour une mise en relation rapide.</p>
                            </div>
                            <ContactForm domain="expertsecuriteincendie.fr" city="Hub National" theme={getTheme('national')} />
                        </div>
                    </div>
                </div>
            </section>
