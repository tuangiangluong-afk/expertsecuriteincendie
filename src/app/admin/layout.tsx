        ...
        <div className="flex h-screen bg-slate-50 font-sans text-slate-900">
            ...
            <aside className="w-64 bg-slate-900 text-white flex flex-col shadow-2xl z-20">
                <div className="p-6 border-b border-white/10">
                    <h1 className="text-xl font-bold tracking-tight">Expert<span className="text-red-500">Admin</span></h1>
                ...
                <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                    ...
                    <Link href="/admin" className="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg bg-red-600 text-white hover:bg-red-500 transition">
                ...
                <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 shadow-sm z-10">
                    ...
                    <div>
                        <a
                            href="/"
                            target="_blank"
                            className="flex items-center gap-2 text-sm text-red-600 font-medium hover:text-red-700 hover:bg-red-50 px-3 py-2 rounded-lg transition"
                        >
                            <Globe size={16} />
                            Voir le site live
                        </a>
