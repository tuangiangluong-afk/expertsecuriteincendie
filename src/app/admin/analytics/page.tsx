            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                    <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                        ...
                        <button className="text-sm text-red-600 hover:underline">Voir tout</button>
                    </div>
                    <div className="p-6">
                        {loading ? (
                                ...
                                {topCities.map((city, i) => (
                                    <div key={i} className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <div className="font-medium text-slate-900 capitalize">{city.name.replace("securiteincendie", "")}</div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <div className="w-full bg-slate-100 rounded-full h-2">
                                        <div className="bg-red-500 h-2 rounded-full" style={{ width: `${(stats.new / stats.total) * 100}%` }}></div>
                                    </div>
                                </div>
                                <div>
                                    <div className="flex justify-between text-sm mb-1">
