...
const HOME_FIELDS = [
    { key: "hero_title", label: "Titre Hero (H1)", type: "text", placeholder: "maintenance extincteur à..." },
    ...
    { key: "about_text", label: "Texte 'À Propos'", type: "textarea", placeholder: "Nous sommes experts..." },
];
                    ...
                    <form onSubmit={handleSave} className="p-8 space-y-6">
                        {HOME_FIELDS.map((field) => (
                            <div key={field.key} className="space-y-2">
                                ...
                                {field.type === 'textarea' ? (
                                    <textarea
                                        className="w-full border border-slate-300 rounded-lg p-3 focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition min-h-[100px]"
                                    ...
                                    <input
                                        type="text"
                                        className="w-full border border-slate-300 rounded-lg p-3 focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition"
                                        placeholder={field.placeholder}
                                        value={contentMap[field.key] || ""}
                                        onChange={e => handleChange(field.key, e.target.value)}
                                    />
