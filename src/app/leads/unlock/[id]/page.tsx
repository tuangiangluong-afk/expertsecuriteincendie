        ...
        <div className="min-h-screen bg-[#f8fafc] text-slate-900">
            ...
            <header className="bg-white border-b border-slate-200 sticky top-0 z-50 py-4">
                <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
                    <Logo isHub size="md" />
                    <div className="hidden md:flex items-center gap-4 bg-red-50 border border-red-100 px-4 py-2 rounded-full">
                        <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></div>
                        <span className="text-xs font-bold text-red-700 uppercase tracking-wider">Espace Partenaires Certifiés</span>
                    </div>
                </div>
            </header>
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="text-center mb-12">
                        {isUnlocked ? (
                            ...
                            <div className="inline-flex items-center gap-2 bg-red-600 text-white px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest mb-6 shadow-lg shadow-blue-500/20">
                                <Lock size={14} />
                                Lead Exclusif
                            </div>
                        )}
                        <h1 className="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tight leading-tight">
                            maintenance ({lead.postal_code})
                        </h1>
                            ...
                            <div className="p-10 space-y-10 animate-in fade-in zoom-in-95 duration-500">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
                                        ...
                                        <a href={`mailto:${lead.email}`} className="text-sm text-red-600 font-bold hover:underline flex items-center gap-1">
                                    ...
                                    <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100">
                                        ...
                                        <a href={`tel:${lead.phone}`} className="text-sm text-red-600 font-bold hover:underline flex items-center gap-1">
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            <div className="flex items-start gap-4">
                                                <div className="w-12 h-12 bg-red-50 text-red-600 rounded-2xl flex items-center justify-center shrink-0 shadow-sm">
                                                    <MapPin size={24} />
                                                </div>
                                                <div>
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div>
                                                    <p className="text-sm text-slate-500 font-bold mb-1">Type de maintenance</p>
                                    ...
                                    {lead.notes && (
                                        <div className="bg-red-600 rounded-3xl p-8 text-white relative overflow-hidden group">
                                            ...
                                            <div className="relative z-10">
                                                <h3 className="text-xs font-black text-red-100 uppercase tracking-[0.2em] mb-4 flex items-center gap-2">
                                                    <ShieldCheck size={16} />
                                    ...
                                    <div className="pt-10 border-t border-slate-100 text-center">
                                        {!partner ? (
                                            <form onSubmit={handleVerifyEmail} className="max-w-md mx-auto">
                                                <h3 className="text-2xl font-black text-slate-900 mb-6 tracking-tight">Accès réservé aux techniciens</h3>
                                                <div className="flex flex-col gap-4">
                                                    <div className="relative">
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full pl-14 pr-6 py-5 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-red-500/10 focus:border-red-500 focus:bg-white transition-all outline-none font-medium"
                                                        />
                                                    </div>
                                            ...
                                            <div className="animate-in fade-in slide-in-from-bottom-6 duration-500">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full max-w-md mx-auto group relative flex items-center justify-center gap-4 bg-red-600 hover:bg-red-700 text-white py-6 rounded-3xl font-black text-2xl shadow-[0_20px_50px_rgba(37,99,235,0.3)] transition-all transform hover:-translate-y-2 active:scale-95"
                                                >
                    ...
                    <footer className="text-center space-y-6">
                        <p className="text-slate-400 text-xs font-medium px-12 leading-relaxed">
                            Expert Sécurité Incendie garantit l'exclusivité de ce lead. En achetant ces coordonnées, vous bénéficiez de l'accès unique à ce projet client.
                        </p>
