...
export async function generateMetadata({
    ...
    return {
        title: `Demande reçue | ${config?.name || "Expert Sécurité Incendie"}`,
        description: "Votre demande de devis a été envoyée avec succès. Un expert vous contactera sous 24h.",
        robots: { index: false, follow: false },
        alternates: {
            canonical: `https://${config?.domain || "expertsecuriteincendie.fr"}/success`,
        },
    };
}
...
const timelineSteps: TimelineStep[] = [
    ...
    },
    {
        ...
        timing: "Évaluation sur site",
        description: "Un technicien certifié visitera votre domicile pour vérifier le registre de sécurité et déterminer le meilleur emplacement.",
        active: false,
    },
    {
...
export default async function SuccessPage({
    ...
    const config = getSiteConfig(domain);
    const siteName = config?.name || "Expert Sécurité Incendie";
                ...
                <Link href={`/${domain}`} className="flex items-center gap-3">
                    <div className="h-8 w-8 bg-red-600 rounded-lg flex items-center justify-center text-white">
                        <svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5">
                            <path d="M11 1L3 11H10V23L19 12H12V1Z" />
                        </svg>
                    </div>
            ...
            <main className="max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-16">
                ...
                <div className="flex flex-col items-center justify-center text-center mb-12">
                    ...
                    <p className="text-lg text-slate-600 max-w-xl">
                        Vous êtes sur la bonne voie pour protectionr chez vous. Un de nos experts matériel incendie
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-7">
                                ...
                                {timelineSteps.map((step, index) => (
                                    <div key={index} className="flex gap-4">
                                        ...
                                        <div className="flex-1 pb-8">
                                            ...
                                            <p className={`text-sm font-medium mb-1 ${step.active ? "text-red-600" : "text-slate-500"
                                                }`}>
                                                {step.timing}
                                            </p>
                        ...
                        <div className="mt-6 flex flex-wrap justify-center gap-8 opacity-60">
                            {["QUALIFELEC", "Incendie", "Aide"].map((badge) => (
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6">
                        ...
                        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-xl p-1 shadow-lg text-white overflow-hidden relative">
                            ...
                            <div className="p-6 md:p-8 relative z-10">
                                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-red-600/20 border border-red-600/30 text-xs font-bold text-red-400 mb-3">
                        ...
                        <div className="bg-white rounded-xl p-6 border border-slate-100 shadow-sm flex flex-col sm:flex-row gap-5 items-center">
                            ...
                            <div className="flex-1 text-center sm:text-left">
                                <h4 className="text-slate-900 font-bold mb-1">Parrainez un ami</h4>
                                <p className="text-slate-500 text-sm mb-3">
                                    Vous connaissez quelqu&apos;un qui achète un VE ?
                                    Obtenez <span className="font-bold text-slate-800">50€ de réduction</span> sur
                                    votre maintenance pour chaque parrainage.
                                </p>
                                <button className="text-sm font-semibold text-red-600 hover:text-red-700 flex items-center gap-1 mx-auto sm:mx-0">
