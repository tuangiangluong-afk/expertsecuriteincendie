...
export async function generateMetadata({ params }: { params: Promise<{ domain: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        description: `Retrouvez nos Conditions Générales de Vente (CGV) pour la mise en relation avec des techniciens Incendie : devis, responsabilités et litiges.`,
        alternates: {
                ...
                <div className="prose prose-neutral prose-lg max-w-none">
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                            ...
                            <li><strong>Tarification :</strong> Le service de mise en relation et l&apos;établissement des devis par nos partenaires sont gratuits pour l&apos;utilisateur. Le prix final de l&apos;maintenance est déterminé par l&apos;technicien partenaire après visite technique.</li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <p>
                            L&apos;Éditeur ne saurait être tenu responsable des retards ou impossibilités techniques rencontrés par les techniciens partenaires.
                        </p>
                    </div>
