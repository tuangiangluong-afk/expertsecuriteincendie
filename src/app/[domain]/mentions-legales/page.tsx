            ...
            <main className="container mx-auto max-w-3xl px-4 py-12 lg:py-20 mb-20">
                ...
                <div className="prose prose-neutral prose-lg max-w-none">
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <p>
                            Le Site a pour objet de fournir une plateforme de mise en relation et d'obtention de devis pour la maintenance du matériel incendie (extincteurs, blocs d'éclairage de sécurité, désenfumage) sur la commune de <strong>{city.city}</strong> et ses environs ({city.neighborhoods.slice(0, 6).join(", ") || "agglomération"}).
                        </p>
                        <p>
                            Les services de maintenance sont assurés par des techniciens indépendants ou des sociétés spécialisées, titulaires des qualifications du secteur (règles APSAD R4 pour les extincteurs, APSAD R12 pour les blocs d'éclairage de sécurité) et des assurances professionnelles obligatoires.
                        </p>
                    </div>
                    ...
                    <div className="mb-8 rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                        ...
                        <p>
                            Les informations collectées via le module de demande de devis (nom, téléphone, adresse) sont nécessaires au traitement de votre demande d&apos;maintenance. Elles sont transmises exclusivement aux techniciens partenaires certifiés Incendie.
                        </p>
                        <p>
