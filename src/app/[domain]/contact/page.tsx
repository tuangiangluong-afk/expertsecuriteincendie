...
export async function generateMetadata({ params }: { params: Promise<{ domain: string }> }): Promise<Metadata> {
    ...
    return {
        title: `Contact Sécurité Incendie ${city.city} | Devis Gratuit`,
        description: `Contactez votre technicien Incendie à ${city.city}. Devis gratuit pour maison, copropriété et entreprise. Réponse sous 48h.`,
        alternates: {
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white rounded-3xl p-8 shadow-sm border border-neutral-200 h-full">
                            ...
                            <div className="bg-neutral-50 rounded-xl p-4 text-sm text-neutral-600">
                                Pour une étude complète (copropriété ou entreprise), n&apos;hésitez pas à joindre des photos de votre registre de sécurité via le formulaire.
                            </div>
                        </div>
                    </div>
