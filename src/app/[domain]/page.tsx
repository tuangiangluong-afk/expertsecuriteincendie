...
export default async function SitePage({ params, basePath }: SitePageProps) {
    ...
    type ThemeColor = 'red' | 'emerald' | 'amber' | 'purple';
    ...
    const colors = {
        red: { primary: 'bg-red-600', hover: 'hover:bg-red-700', text: 'text-red-600', light: 'bg-red-50', border: 'border-red-200', gradient: 'from-red-600 to-red-800', shadow: 'shadow-red-500/20' },
        blue: {
            primary: "bg-red-600",
    ...
    const coloredH1Content = h1Content.replace(/text-red-500/g, palette.text);
        ...
        <div className="min-h-screen font-sans text-neutral-900 bg-neutral-50">
                            ...
                            <div className="relative h-[640px] w-full mb-8">
                                <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/20 border border-slate-100 bg-white p-2">
                                    <div className="relative w-full h-full rounded-xl overflow-hidden">
                                        <SafeImage
                                            src={site.heroImage || "/images/realizations/hero-extincteur.jpg"}
                                            fallbackSrc="/images/realizations/hero-extincteur.jpg"
                                            alt={`maintenance extincteur protection ${site.city}`}
                                            fill
                                        ...
                                        <div className="absolute bottom-8 left-8 right-8 z-20">
                                            <div className="bg-white/95 backdrop-blur rounded-xl p-5 shadow-xl border border-white/50 flex items-center gap-4 cursor-default">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-sm font-medium text-slate-500">Norme NF EN 3</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="grid md:grid-cols-2">
                                    ...
                                    <div className="p-8 bg-green-50 relative rounded-b-3xl md:rounded-bl-none md:rounded-r-3xl">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex justify-between items-center py-3 border-b border-green-100">
                                                <span className="text-neutral-700">Prix kgh HC*</span>
            ...
            {isHub && (
                <section className="py-20 bg-white">
                    <div className="container mx-auto px-4">
                        <div className="text-center mb-12">
                            <h2 className="text-3xl sm:text-4xl font-bold text-neutral-900 mb-4">
                                Types d&apos;maintenances &amp; Prix Moyens
                            </h2>
                                ...
                                <Link key={i} href={service.href} className="block group h-full">
                                    <div
                                        ...
                                        ${service.highlight
                                                ...
                                                : 'border-neutral-200 bg-white hover:border-red-500 hover:shadow-xl group-hover:scale-[1.02]'
                                            }
                                    `}
                                    >
                                        {service.highlight && (
                                        ...
                                        ${service.color === 'blue' ? 'bg-red-100 text-red-600' : ''}
                                        ${service.color === 'purple' ? 'bg-purple-100 text-purple-600' : ''}
                                        ${service.color === 'emerald' ? 'bg-emerald-100 text-emerald-600' : ''}
                                    `}>
                                            <service.icon size={28} />
                                        </div>
                                        <h3 className="text-xl font-bold text-neutral-900 mb-3 group-hover:text-red-600 transition-colors">{service.title}</h3>
                                        ...
                                        <div className="text-red-600 font-bold inline-flex items-center mt-auto">
            ...
            <section className="py-20 bg-neutral-900 text-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                            Trouvez votre technicien en <span className="text-red-400">3 étapes</span>
                        </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        {[
                            ...
                            },
                            {
                                ...
                                description: "Recevez jusqu&apos;à 3 devis de techniciens locaux certifiés Incendie.",
                                icon: Shield
                            },
                            {
                                step: "03",
                            ...
                            <div key={i} className="text-center">
                                <div className="relative inline-block mb-6">
                                    <div className="w-20 h-20 bg-red-600 rounded-2xl flex items-center justify-center mx-auto">
                                        <item.icon size={32} />
                                    </div>
                    ...
                    <div className="text-center mt-12">
                        <a
                            href="#simulateur"
                            className="inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-red-600 to-red-700 px-8 py-4 text-lg font-bold text-white shadow-xl shadow-blue-500/30 hover:shadow-blue-500/50 hover:-translate-y-1 transition-all"
                        >
                            <Zap size={24} />
                            Comparer les Devis
                        </a>
            ...
            <ExtinguisherComparison themeColor={themeColor} />
            <RealizationsGrid />
                ...
                <section className="py-16 bg-neutral-50 border-t border-neutral-200">
                    <div className="container mx-auto px-4">
                        <h3 className="text-2xl font-bold text-neutral-900 mb-6">
                            maintenance matériel incendie à {site.city} et environs
                        </h3>
                        <div className="flex flex-wrap gap-3">
                            {site.quartiers.map((quartier: string, i: number) => (
                                <Link
                                    ...
                                    className="inline-block bg-white px-4 py-2 rounded-full text-sm text-neutral-700 border border-neutral-200 hover:border-red-500 hover:text-red-600 hover:shadow-sm transition-colors cursor-pointer"
                                >
                                    Sécurité Incendie {quartier}
                                </Link>
                            ))}
                        </div>
                    </div>
