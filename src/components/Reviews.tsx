...
export default function Reviews({ site, themeColor = 'red' }: ReviewsProps) {
    ...
    const highlightClass = themeStyles[themeColor] || themeStyles.red;
                    ...
                    {reviews.map((review) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3 mt-auto pt-4 border-t border-neutral-200/50">
                                <div className="h-9 w-9 rounded-full bg-gradient-to-br from-red-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm shadow-lg">
