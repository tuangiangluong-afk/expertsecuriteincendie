...
export default function ContactForm({ domain, city, theme }: ContactFormProps) {
    ...
    const inputClasses = `w-full rounded-xl border border-neutral-300 px-4 py-3 text-neutral-900 focus:border-red-500 focus:ring-red-500 transition outline-none bg-white font-medium`;
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    >
                        ...
                        <option value="partenariat_technicien">Devenir technicien Partenaire</option>
