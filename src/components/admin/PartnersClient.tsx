            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-slate-500">
                        {partners.length} techniciens / partenaires enregistrés
                    </p>
                </div>
                <button
                    onClick={openAddModal}
                    className="flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition font-medium shadow-lg shadow-blue-900/20"
                >
                    <Plus size={18} />
                        ...
                        <div className="space-y-4 text-sm text-slate-600 flex-1">
                            <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <a href={`mailto:${partner.email}`} className="hover:text-red-600">{partner.email}</a>
                                </div>
                                {partner.phone && (
                                    <div className="flex items-center gap-2">
                            ...
                            <div className="pt-2 border-t border-slate-100">
                                ...
                                <div className="flex flex-wrap gap-1">
                                    {partner.managed_regions && partner.managed_regions.map(r => (
                                        <span key={r} className="bg-red-50 text-red-600 text-[10px] px-2 py-0.5 rounded border border-red-100">
                                            {r}
                                        </span>
                                    ))}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 outline-none font-mono text-sm" 
                                />
                            </div>
                            ...
                            <div className="flex gap-3 pt-4 border-t border-slate-100">
                                ...
                                <button type="submit" disabled={loading} className="flex-1 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 font-bold disabled:opacity-50 shadow-lg shadow-blue-900/20">
