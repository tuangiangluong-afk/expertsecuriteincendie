            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                    <span className="text-xs bg-red-50 text-red-600 px-3 py-1 rounded-full font-bold border border-red-100 flex items-center gap-1">
                        <Globe size={12} /> Réseau Incendie Actif
                    </span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
                    ...
                    <div className="space-y-4">
                        ...
                        <Link href="/admin/analytics" className="flex items-center justify-between p-4 bg-slate-50 rounded-lg hover:bg-red-50 hover:text-red-700 transition group border border-slate-100">
                ...
                <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <Link href="/admin/leads" className="text-xs text-red-600 font-bold hover:underline">Voir tout</Link>
                    </div>
                        ...
                        <ul className="space-y-4">
                            {recentActivity.map((lead) => (
                                <li key={lead.id} className="flex items-center justify-between pb-4 border-b border-slate-100 last:border-0 last:pb-0">
                                    ...
                                    <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase ${lead.status === 'new' ? 'bg-red-50 text-red-700' :
