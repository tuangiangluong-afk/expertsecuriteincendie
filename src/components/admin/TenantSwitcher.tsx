        ...
        <div className="flex items-center gap-2">
            <div className="relative">
                ...
                <select
                    ...
                    className="bg-white border border-slate-300 text-slate-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-64 pl-10 p-2.5 appearance-none cursor-pointer hover:bg-slate-50 transition shadow-sm"
                >
