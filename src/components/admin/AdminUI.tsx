...
export function Button({ 
    ...
    const variants = {
        primary: 'bg-red-600 text-white hover:bg-red-700 shadow-lg shadow-blue-500/20',
...
export function Textarea({ className, ...props }: React.TextareaHTMLAttributes<HTMLTextAreaElement>) {
    return (
        <textarea
            className={cn(
                "w-full min-h-[100px] bg-white border border-slate-300 rounded-xl p-3 text-sm focus:ring-4 focus:ring-red-500/10 focus:border-red-500 outline-none transition placeholder:text-slate-400",
                className
            )}
            {...props}
        />
