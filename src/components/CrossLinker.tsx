...
const TOP_CITIES = [
    { name: "Paris", slug: "paris", domain: "securiteincendieparis.fr" },
    { name: "Lyon", slug: "lyon", domain: "expertsecuriteincendie.fr/ville/lyon" },
    { name: "Bordeaux", slug: "bordeaux", domain: "expertsecuriteincendie.fr/ville/bordeaux" },
    { name: "Marseille", slug: "marseille", domain: "securiteincendiemarseille.fr" },
    { name: "Toulouse", slug: "toulouse", domain: "expertsecuriteincendie.fr/ville/toulouse" },
];
    ...
    return (
        <div className="bg-slate-900 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 border border-slate-800 shadow-2xl my-12">
            <div className="flex items-start gap-4">
                <div className="p-3 bg-red-600 rounded-xl hidden sm:block">
                    <MapPin className="text-white" size={24} />
                </div>
                <div>
                    <h3 className="text-white font-bold text-lg mb-1">
                        technicien agréé {brandName} à proximité
                    </h3>
                    <p className="text-slate-400 text-sm max-w-md">
                        Notre réseau couvre toute la France. Trouvez votre expert local certifié pour une maintenance conforme.
                    </p>
                </div>
            </div>
            ...
            <Link
                ...
                className="w-full sm:w-auto bg-white text-slate-900 hover:bg-red-50 px-6 py-3 rounded-xl font-bold text-center flex items-center justify-center gap-2 transition-all"
            >
