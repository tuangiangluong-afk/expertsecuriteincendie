                ...
                <div className="p-6 space-y-6">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3 rounded-xl bg-neutral-50 p-4 border border-neutral-100">
                            ...
                            <div>
                                <p className="text-sm font-semibold text-neutral-900">techniciens Certifiés</p>
                                <p className="text-xs text-neutral-500">Service certifié Incendie & APSAD</p>
                            </div>
                        </div>
