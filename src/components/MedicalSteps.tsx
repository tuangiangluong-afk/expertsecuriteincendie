        ...
        <div className="py-10">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
                ...
                <div className="relative text-center p-6 bg-white rounded-2xl border border-slate-200 shadow-sm">
                    ...
                    <div className="mx-auto h-16 w-16 bg-red-100 rounded-full flex items-center justify-center text-red-600 mb-4 mt-2">
                        <FileText size={32} />
                    </div>
            ...
            {/* Trust Badge */}
            <div className="bg-red-50 border border-red-200 p-5 rounded-2xl text-center max-w-2xl mx-auto">
